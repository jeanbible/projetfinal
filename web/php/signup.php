			...
			<div class="login-body">
				...
				<div class="login-info">
					<form method="post" action="inscriptionMembre.php">
					    ...
					    <input type="text" name="prenom" class="form-control" id="prenom" required=""  placeholder="Prenom">
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" name="phone" class="form-control" id="phone" required=""  placeholder="Numéro de téléphone">
					  </div>
						<div class="form-group">
						...
						<div class="form-group">
					    <label for="paswrd">Mot de passe</label>
					    <input type="password" name="paswd" class="form-control" id="paswd" placeholder="Mot de passe" required="">
					  </div>
						<button type="submit" class="btn btn-primary mb-2">Inscription</button>
